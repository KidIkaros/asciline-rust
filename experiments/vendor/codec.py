# Vendored UNMODIFIED from https://github.com/YusufB5/ASCILINE (commit
# 7003c2f, 2026-08) — Copyright (c) 2026 YusufB5, MIT (with Anti-Advertisement
# Restriction). It is used ONLY to regenerate the committed differential test
# vectors (experiments/gen_python_vectors.py, gen_profile_vectors.py) with the
# exact encoder the Rust port is verified against. Pinning it here keeps those
# vectors reproducible in CI without numpy-free guarantees or a checkout of the
# upstream repo, and shields the checks from upstream changes. See NOTICE.
"""
